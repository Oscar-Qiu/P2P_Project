...
public class ClientProcess extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" + currID + peerID);
            ...
            System.out.println("Peer's replyyyyyyyyyyyyyyyyyyyyyyyy: " + interested);

            if(interested) {
                out.writeObject(m.genIntMsg());
                Logger.receiveInterested(peerID);
            }
            else {
                out.writeObject(m.genNotIntMsg());
                Logger.receiveNotInterested(peerID);
            }
